  ...
  create type public.reading_status as enum ('up_next', 'in_progress', 'completed');
  ...
  -- Optional: if you already have reading_books, add columns without dropping the table:
